...
export const Notifications = () => {
    ...
    const notificationTypeStyles = {
        ...
        chat_status_change: {
            icon: "fa-refresh",
            color: "bg-info",
            title: "Cambio de estado de chat",
        },
        agent_assigned: {
            icon: "fa-user-check",
            color: "bg-success",
    ...
    const handleNewNotification = (data) => {
        ...
        const { title } =
            notificationTypeStyles[data.type] || notificationTypeStyles.default;
    ...
    return (
        <>
            ...
            {openDropdown && (
                <ul
                    className="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4 show shadow"
                    ...
                    {notifications?.map((notification, index) => {
                        ...
                        return (
                            <li key={index} className="mb-2">
                                <Link
                                    to={`/support/${
                                        ternToJson(notification.content).chat
                                            .chat.id
                                    }`}
                                    onClick={() =>
                                        putNotificatoionsRead(notification.id)
                                    }
                                ...
                                >
                                    <div className="d-flex py-1">
                                        <div className="my-auto">
                                            <div
                                                className={`avatar avatar-sm ${color} me-3`}
                                            >
                                                <i className={`fa ${icon}`} />
                                            </div>
                                        </div>
