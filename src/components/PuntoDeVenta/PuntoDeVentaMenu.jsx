...
const PuntoDeVentaMenu = ({ handleChangeDepartment }) => {
    ...
    return (
        <div className="dropdown">
            ...
            >
                ...
                >
                    <i className="fas fa-truck-loading" /> Inventario
                </Link>
                <button
                    onClick={handleChangeDepartment}
                    className="dropdown-item cursor-pointer"
                >
                    <i className="fas fa-cash-register" /> Departamento por
                    Defecto
                </button>
                ...
                >
                    {localStorage.getItem("audio") === "true" ? (
                        <span>
                            <i className="fas fa-volume-up" /> Con{" "}
                        </span>
                    ) : (
                        <span>
                            <i className="fas fa-volume-mute" /> Sin{" "}
                        </span>
                    )}{" "}
                    Guía de Audio
                </a>
                <a className="dropdown-item cursor-pointer">
                    <i className="fas fa-file-alt" /> Reportes
                </a>
                <a className="dropdown-item cursor-pointer">
                    <i className="fas fa-angle-double-right" /> Otra Opción
                </a>
            </div>
        </div>
    );
